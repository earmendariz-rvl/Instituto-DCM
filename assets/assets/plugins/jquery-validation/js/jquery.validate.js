...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Favor de revisar este campo.",
		email: "Ingrese un Email valido.",
		url: "Ingrese una dirección valida.",
		date: "Ingrese una fecha valida.",
		dateISO: "Ingrese una fecha valida ( YYYY-MM-DD ).",
		...
		minlength: $.validator.format( "No ingrese menos de {0} caracteres." ),
		rangelength: $.validator.format( "El campo debe de tener entre {0} y {1} caranteres de largo." ),
